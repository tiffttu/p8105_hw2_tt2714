...
## Problem 3
Installation and library for BRFSS dataset
Clean BRFSS data, select Overall Health topic
```{r clean BRFSS data}
...
There are `r length(unique(overallhealth_brfss_smart2010$locationabbr))` unique locations included in this dataset. Every state is included in this dataset, including District of Columbia. The most frequent occurence is `r max(overallhealth_brfss_smart2010$locationabbr)` out of all the states represented.  

The median of the "Excellent" response value for 2002 is `r median(subset(overallhealth_brfss_smart2010, year == 2002)$excellent, na.rm = TRUE)`.
